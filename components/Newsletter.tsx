...
function Newsletter() {
    return (
        <div className='w-full p-16 relative flex items-center justify-center'>
            ...
            <div className='flex items-center justify-center absolute flex-col p-4'>
                ...
                <p className='text-black w-[70%] font-medium text-center '>Although I’m not currently looking for any new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I’ll try my best to get back to you!</p>
