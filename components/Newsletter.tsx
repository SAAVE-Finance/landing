    ...
    <div className="w-full p-16 relative flex items-center justify-center">
      ...
      <div className="flex items-center justify-center absolute flex-col p-4">
        ...
        <div className="m-4 p-1 rounded-full w-1/2 md:w-1/3 bg-transparent border-2 border-black flex">
          ...
          <input
            className="p-2 w-full rounded-full focus:outline-none bg-transparent "
            type="email"
            id="name"
            placeholder="Enter Your Mail"
          />
          <button className="text-white bg-black sm:block rounded-full w-48 text-base font-medium px-2">
            Submit
          </button>
        </div>
      </div>
