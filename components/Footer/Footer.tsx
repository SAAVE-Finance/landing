...
const Footer = () => {
  return (
    <footer aria-label="Site Footer" className="bg-black text-gray-100">
      <div className="max-w-screen-xl px-4 pt-16 pb-7 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8 mb-0">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            <div>
              <p className="font-medium text-gray-100">Learn</p>

              <nav aria-label="Footer Navigation - Learn" className="mt-6">
            ...
            <div>
              <p className="font-medium text-gray-100">Build</p>

              <nav aria-label="Footer Navigation - Build" className="mt-6">
                <ul className="space-y-4 text-sm">
                  <li>
                    <a
                      href="#"
            ...
            <div>
              <p className="font-medium text-gray-100">Explore</p>
            ...
            <div>
              <p className="font-medium text-gray-100">Resources</p>
